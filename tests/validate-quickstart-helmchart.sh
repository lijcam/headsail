...
main() {
  ...
  cd workspace 
  helm template ./charts/quickstart-chart --values $SESSION_YAML --debug 
  helm install debug-quickstart ./charts/quickstart-chart --values $SESSION_YAML --set debugMode=True --debug ||
  helm upgrade debug-quickstart ./charts/quickstart-chart --values $SESSION_YAML --set debugMode=True --debug
